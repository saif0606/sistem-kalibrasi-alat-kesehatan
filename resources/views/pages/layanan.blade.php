...
@section('content')
    ...
    @php
        $categoryMeta = [
            'Monitoring'    => ['icon' => 'bi-activity',           'color' => 'blue'],
            'Diagnostik'    => ['icon' => 'bi-clipboard2-pulse',   'color' => 'green'],
            'Terapi'        => ['icon' => 'bi-heart-pulse',        'color' => 'blue'],
            'Laboratorium'  => ['icon' => 'bi-droplet-half',       'color' => 'green'],
            'Sterilisasi'   => ['icon' => 'bi-shield-check',       'color' => 'blue'],
            'Neonatal'      => ['icon' => 'bi-emoji-smile',        'color' => 'green'],
            'Respiratory'   => ['icon' => 'bi-lungs',              'color' => 'blue'],
        ];

        $equipments = [
            ['slug' => 'tensimeter', 'name' => 'Sphygmomanometer / Tensimeter', 'category' => 'Diagnostik', 'price' => 84000, 'desc' => 'Alat pengukur tekanan darah non-invasif untuk pemeriksaan rutin pasien.', 'gambar' => 'katalog/tensimeter.jpg'],
            ['slug' => 'spo2', 'name' => 'Pulse Oximetri (SPO2 Monitor)', 'category' => 'Monitoring', 'price' => 180000, 'desc' => 'Alat pemantau saturasi oksigen dan denyut nadi pasien.', 'gambar' => 'katalog/spo2.jpg'],
            ['slug' => 'nebulizer', 'name' => 'Nebulizer', 'category' => 'Respiratory', 'price' => 228000, 'desc' => 'Alat terapi uap untuk pengobatan saluran pernapasan.', 'gambar' => 'katalog/nebulizer.jpg'],
            ['slug' => 'bpm', 'name' => 'Blood Pressure Monitor (BPM) / Non Invasive', 'category' => 'Monitoring', 'price' => 162000, 'desc' => 'Monitor tekanan darah non-invasif untuk pemantauan berkelanjutan.', 'gambar' => 'katalog/bpm.jpg'],
            ['slug' => 'regulator-oksigen', 'name' => 'Regulator Oksigen (Flow Meter)', 'category' => 'Respiratory', 'price' => 192000, 'desc' => 'Alat pengatur aliran oksigen medis ke pasien.', 'gambar' => 'katalog/regulator-oksigen.jpg'],
            ['slug' => 'timbangan-bayi', 'name' => 'Timbangan Bayi', 'category' => 'Neonatal', 'price' => 180000, 'desc' => 'Timbangan digital/analog untuk pemantauan berat badan bayi.', 'gambar' => 'katalog/timbangan-bayi.jpg'],
            ['slug' => 'fetal-doppler', 'name' => 'Fetal Detector / Doppler', 'category' => 'Diagnostik', 'price' => 156000, 'desc' => 'Alat pendeteksi detak jantung janin.', 'gambar' => 'katalog/fetal-doppler.jpg'],
            ['slug' => 'suction-pump', 'name' => 'Suction Pump / Alat Hisap Medik', 'category' => 'Terapi', 'price' => 264000, 'desc' => 'Alat penghisap cairan/lendir untuk tindakan medis.', 'gambar' => 'katalog/suction-pump.jpg'],
            ['slug' => 'ecg', 'name' => 'ECG (Electrocardiograph) Monitor', 'category' => 'Diagnostik', 'price' => 168000, 'desc' => 'Alat perekam aktivitas listrik jantung.', 'gambar' => 'katalog/ecg.jpg'],
            ['slug' => 'centrifuge', 'name' => 'Centrifuge', 'category' => 'Laboratorium', 'price' => 240000, 'desc' => 'Alat pemutar sampel laboratorium untuk pemisahan cairan.', 'gambar' => 'katalog/centrifuge.jpg'],
            ['slug' => 'usg', 'name' => 'Ultrasonography (USG)', 'category' => 'Diagnostik', 'price' => 300000, 'desc' => 'Alat pencitraan diagnostik menggunakan gelombang ultrasonik.', 'gambar' => 'katalog/usg.jpg'],
            ['slug' => 'autoclave', 'name' => 'Autoclave', 'category' => 'Sterilisasi', 'price' => 312000, 'desc' => 'Alat sterilisasi peralatan medis menggunakan uap bertekanan tinggi.', 'gambar' => 'katalog/autoclave.jpg'],
            ['slug' => 'infant-warmer', 'name' => 'Infant Warmer', 'category' => 'Neonatal', 'price' => 240000, 'desc' => 'Alat penghangat bayi untuk menjaga suhu tubuh optimal.', 'gambar' => 'katalog/infant-warmer.jpg'],
            ['slug' => 'inkubator', 'name' => 'Inkubator Perawatan', 'category' => 'Neonatal', 'price' => 324000, 'desc' => 'Alat perawatan bayi dengan kontrol suhu dan kelembapan.', 'gambar' => 'katalog/inkubator.jpg'],
            ['slug' => 'bedside-monitor', 'name' => 'Monitor Pasien (Bed Side Monitor)', 'category' => 'Monitoring', 'price' => 588000, 'desc' => 'Monitor multiparameter untuk memantau kondisi vital pasien.', 'gambar' => 'katalog/bedside-monitor.jpg'],
            ['slug' => 'sterilisator-kering', 'name' => 'Sterilisator Kering', 'category' => 'Sterilisasi', 'price' => 204000, 'desc' => 'Alat sterilisasi menggunakan panas kering.', 'gambar' => 'katalog/sterilisator-kering.jpg'],
            ['slug' => 'phototherapy', 'name' => 'Phototherapy Unit / Blue Light', 'category' => 'Neonatal', 'price' => 204000, 'desc' => 'Alat terapi sinar untuk penanganan bayi kuning (ikterus).', 'gambar' => 'katalog/phototherapy.jpg'],
            ['slug' => 'lampu-operasi', 'name' => 'Lampu Operasi', 'category' => 'Terapi', 'price' => 192000, 'desc' => 'Lampu penerangan khusus untuk ruang tindakan/operasi.', 'gambar' => 'katalog/lampu-operasi.jpg'],
            ['slug' => 'ctg', 'name' => 'Cardiotocograph (CTG)', 'category' => 'Diagnostik', 'price' => 168000, 'desc' => 'Alat pemantau detak jantung janin dan kontraksi rahim.', 'gambar' => 'katalog/ctg.jpg'],
            ['slug' => 'defibrillator', 'name' => 'Defibrillator Monitor', 'category' => 'Terapi', 'price' => 300000, 'desc' => 'Alat kejut jantung untuk penanganan kondisi gawat darurat.', 'gambar' => 'katalog/defibrillator.jpg'],
            ['slug' => 'infusion-pump', 'name' => 'Infusion Pump', 'category' => 'Terapi', 'price' => 288000, 'desc' => 'Alat pengatur laju cairan infus secara presisi.', 'gambar' => 'katalog/infusion-pump.jpg'],
            ['slug' => 'syringe-pump', 'name' => 'Syringe Pump', 'category' => 'Terapi', 'price' => 288000, 'desc' => 'Alat pengatur pemberian obat/cairan dosis kecil secara presisi.', 'gambar' => 'katalog/syringe-pump.jpg'],
            ['slug' => 'spirometer', 'name' => 'Spirometer', 'category' => 'Respiratory', 'price' => 156000, 'desc' => 'Alat pengukur kapasitas dan fungsi paru-paru.', 'gambar' => 'katalog/spirometer.jpg'],
            ['slug' => 'cpap', 'name' => 'Continuous Positive Airway Pressure (CPAP)', 'category' => 'Respiratory', 'price' => 396000, 'desc' => 'Alat bantu napas tekanan positif berkelanjutan.', 'gambar' => 'katalog/cpap.jpg'],
        ];

        foreach ($equipments as $i => $eq) {
            $equipments[$i]['icon'] = $categoryMeta[$eq['category']]['icon'];
            $equipments[$i]['color'] = $categoryMeta[$eq['category']]['color'];
            // Foto asli alat — taruh file di public/images/katalog/{slug}.jpg lalu
            // isi path di sini. Selama masih null, kartu memakai ikon (bukan
            // gambar dummy/placeholder).
            $equipments[$i]['gambar'] = isset($eq['gambar']) ? asset('images/' . $eq['gambar']) : null;
        }
    @endphp
                ...
                @foreach ($equipments as $item)
                    <div class="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="{{ ($loop->index % 4) * 60 }}">
                        <div class="katalog-card">
                            <div class="katalog-card-visual katalog-visual-{{ $item['color'] }}">
                            ...
                            <div class="katalog-card-body">
                                <span class="tarif-category-badge tarif-badge-{{ $item['color'] }}">{{ $item['category'] }}</span>
                                <h3>{{ $item['name'] }}</h3>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{ route('dashboard.pengajuan') }}" class="btn btn-hero-primary w-100 justify-content-center">
