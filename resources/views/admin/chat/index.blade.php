...
<div class="chat-container">
    ...
    <div class="chat-list-panel {{ $selectedUser ? 'hide-mobile' : '' }}">
        <div class="chat-search d-flex gap-2 align-items-center">
            <div class="modern-select dropdown" style="flex-grow: 1; min-width: 0;">
                <button class="modern-select-trigger dropdown-toggle w-100 d-flex align-items-center justify-content-between" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                    <span class="modern-select-trigger-label text-truncate text-start" style="max-width: 90%;">
                        @if($selectedUser)
        ...
        <div class="chat-conversations" id="chatConversationsList">
...
<script>
    ...
    // Sidebar Polling (updates user list & unread badges)
    async function pollSidebar() {
        try {
            ...
            const newSidebar = doc.getElementById('chatConversationsList');
            const oldSidebar = document.getElementById('chatConversationsList');
