...
.drop-zone {
    ...
    padding:24px 16px; text-align:center; cursor:pointer; transition:all 0.18s;
...
.preview-panel {
    background:var(--bg-card,#fff); border-radius:16px;
    border:1px solid var(--border-color,rgba(0,0,0,0.07));
    box-shadow:0 2px 12px rgba(0,0,0,0.05); padding:22px 24px;
        ...
        <div class="col-lg-8">
                ...
                <div class="svc-form-section">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name"
                            ...
                            value="{{ old('name') }}" placeholder="Contoh: Kalibrasi Tensimeter..." required>
            ...
            <div class="svc-form-card">
                ...
                <div class="svc-form-section">
                    ...
                    <label for="isKanHidden">
                        <div class="kan-toggle-wrap" id="kanWrap">
                            <input type="hidden" name="is_kan" id="isKanHidden" value="{{ old('is_kan') ? '1' : '0' }}">
            ...
            <div class="d-flex align-items-center gap-3 pb-2">
                <button type="submit" class="btn-save"><i class="bi bi-check-lg"></i> Simpan Layanan</button>
        ...
        <div class="col-lg-4">
            <div class="preview-panel">
                ...
                <div style="margin-top:16px;padding-top:14px;border-top:1px solid var(--border-color,#e2e8f0);">
                    ...
                    <div id="previewName" style="font-size:14px;font-weight:600;color:var(--text-primary);min-height:20px;"></div>
                    <div id="previewPrice" style="font-size:13px;color:#17a45c;font-weight:700;margin-top:4px;min-height:18px;"></div>
                </div>
            </div>
        </div>
    </div>
...
function syncKan() {
    kanWrap.classList.toggle('active', kanOn);
    kanHid.value = kanOn ? '1' : '0';
}
...
function refreshPreview() {
    ...
    if (uploadSrc) {
        ...
        caption.textContent = 'Gambar dari upload'; clearBtn.classList.remove('d-none');
    } else {
