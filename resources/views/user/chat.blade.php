...
body.chat-page-body main { flex: 1; min-height: 0; display: flex; flex-direction: column; overflow: hidden; z-index: 1; position: relative; }
...
.chat-input-card {
    ...
    border-radius: 20px;
    padding: 12px 14px;
    box-shadow: 0 0 0 0 rgba(30,148,71,0);
