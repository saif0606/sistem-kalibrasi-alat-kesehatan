...
class ChatController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->filled('user')) {
            // Tandai semua pesan dari pelanggan ini sebagai sudah dibaca SEBELUM query lain
            ChatMessage::where('user_id', $request->user)
    ...
    public function messages(Request $request, User $user)
    {
        ...
        // Tandai sudah dibaca saat ajax polling agar badge realtime hilang
